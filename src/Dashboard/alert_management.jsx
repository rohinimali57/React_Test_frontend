...
class alert_management extends Component {
  ...
  getAlertType = () => {
    ...
    //       this.setState({ caseList: response.data.content })
  ...
  fetchData = async () => {
    ...
    try {
      ...
      const response =await axios.post(applicationContextPath + '/getAlertClassification?' + param, null, { headers })
      console.log("ssdfasfds===>", response);
      const alertPage = response.data.content;
      this.setState({ caseList: response.data, })
      console.log("alertLIst===>",this.state.caseList);//totalPages: response.data.totalPages
      //this.setState({ data: alertPage.content });
    } catch (error) {
  ...
  handleIdClick = (e, id) => {
    e.preventDefault();
    // Do something when the ID is clicked, e.g., navigate to a new page, show a modal, etc.
                    ...
                    <div className="box">
                      <div className="box-body  no-LR-padding expandcontentscell bs-table-actionButton">
                        ...
                        >
                          ...
                          <TableHeaderColumn csvHeader='In stock' dataField='id' expandable={false} editable={false} width="40px" dataFormat={(cell, row) => (
                            <Link to={{ pathname: `/alert_id`, state: { id: cell } }} >
                              {cell}
                            </Link>
                          )}><a style={{ fontSize: '75%' }} >Alert ID</a></TableHeaderColumn>
                          ...
                          <TableHeaderColumn dataField='customerNo' expandable={false} editable={false} width="70px"><a style={{ fontSize: '75%' }}>Customer Number</a></TableHeaderColumn>
                          ...
                          <TableHeaderColumn dataField='assignedUser' expandable={false} editable={false} width="50px"><a style={{ fontSize: '75%' }}>Assign To</a></TableHeaderColumn>
                          ...
                          <TableHeaderColumn dataField='riskSeverity' expandable={false} editable={false} width="55px"><a style={{ fontSize: '75%' }}>Customer Risk</a></TableHeaderColumn>
...
const mapDispatchToProps = {
   // Map the action creator to props
};
export default connect(mapStateToProps, mapDispatchToProps)(alert_management)
